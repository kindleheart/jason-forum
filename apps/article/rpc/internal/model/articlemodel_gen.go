...
func (m *defaultArticleModel) FindOne(ctx context.Context, id int64) (*Article, error) {
	forumArticleArticleIdKey := fmt.Sprintf("%s%v", cacheForumArticleArticleIdPrefix, id)
	var resp Article
	err := m.QueryRowCtx(ctx, &resp, forumArticleArticleIdKey, func(ctx context.Context, conn sqlx.SqlConn, v any) error {
...
func (m *defaultArticleModel) Insert(ctx context.Context, data *Article) (sql.Result, error) {
	forumArticleArticleIdKey := fmt.Sprintf("%s%v", cacheForumArticleArticleIdPrefix, data.Id)
...
func (m *defaultArticleModel) formatPrimary(primary any) string {
	return fmt.Sprintf("%s%v", cacheForumArticleArticleIdPrefix, primary)
}
